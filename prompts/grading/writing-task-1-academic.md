...
Every criterion `justification` must reference a **specific phrase** from the candidate's response in the `evidence` field. Quote the phrase exactly (use straight quotes). No hand-waving like "good vocabulary" — point to the words you mean.
